...
import { addOrderThunk, deleteOrderItems, fetchOrderIdAndProducts } from "../store/order";
	...
	return (
		<div className="mt-4 leading-loose flex justify-center">
			<form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
				<h2 className="text-gray-800 text-center text-2xl font-bold">Checkout</h2>
				<div className="mt-2">
				...
				<div className="mt-4">
					<p className="mt-4 text-gray-800 font-medium">Order total: ${(cartTotal / 100).toFixed(2)}</p>
					<button
